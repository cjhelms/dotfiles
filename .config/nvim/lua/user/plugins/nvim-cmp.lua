local function configure()
  local function load_snippets() require("luasnip.loaders.from_vscode").lazy_load() end

  local function make_completion_behavior_table() return { completeopt = "menu,menuone,preview,noselect" } end
